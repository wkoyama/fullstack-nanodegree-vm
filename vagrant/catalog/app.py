...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://grader:grader@localhost:5432/catalogitens'
...
engine = create_engine('postgresql://grader:grader@localhost:5432/catalogitens')
